...
namespace LAB07
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try { this.Font = new Font("JetBrains Mono NL", 20); }
            catch { this.Font = new Font("Consolas", 20); }
        ...
        private void OnSelect(object sender, EventArgs e)
        {
            ...
            // Вызываем методы только для НЕЧЁТНЫХ заданий
            switch (selected)
            {
                case "DateTimePicker": DateTimeDemo(); break;   // задание 7
                case "PictureBox": PictureDemo(); break;       // задание 9
                case "Timer": TimerDemo(); break;              // задание 11
                case "ComboBox": ComboDemo(); break;           // задание 13
                case "ColorDialog": ColorDemo(); break;        // задание 15
                case "FontDialog": FontDemo(); break;          // задание 17
            }
        }
        ...
        private void DateTimeDemo()
        {
            ...
            dt.Margin = new Padding(0, 0, 0, 10);
        ...
        private void PictureDemo()
        {
            ...
            load.Click += (s, e) =>
            {
                ...
                {
                    try { pb.Image = Image.FromFile(dlg.FileName); }
        ...
        private void ComboDemo()
        {
            ...
            combo.SelectedIndexChanged += (s, e) =>
            {
                if (combo.SelectedItem != null)
                    lb.Text = "Выбор: " + combo.SelectedItem.ToString();
            };
        ...
        private void ColorDemo()
        {
            ...
            colorBtn.Text = "Выбрать цвет панели";
