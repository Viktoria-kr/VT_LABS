namespace OOP_COLLECTIONS
{
    ...
    public class Department
    {
        ...
        public void AddEmployee(Employee employee)
        {
            ...
            if (employee is Manager && Employees.OfType<Manager>().Any())
            {
                Console.WriteLine($"Ошибка: В отделе {Name} уже есть менеджер! {employee.Name} не добавлен.");
                return;
            }
            ...
            {
                Console.WriteLine($"Ошибка: Сотрудник {employee.Name} (ID: {employee.Id}) уже есть в отделе {Name}");
                return;
            }

            Employees.Add(employee);
            Console.WriteLine($"Добавлен сотрудник {employee.Name} (ID: {employee.Id}) в отдел {Name}");
        }
        ...
        public bool RemoveEmployeeById(int id)
        {
            ...
            if (emp != null)
            {
                ...
                Console.WriteLine($"Сотрудник {emp.Name} (ID: {id}) удалён из отдела {Name}");
                return true;
            }

            Console.WriteLine($"Сотрудник с ID {id} не найден в отделе {Name}");
            return false;
        }
